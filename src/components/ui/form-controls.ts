 ...
 */
const base =
    "w-full rounded-xl border border-[#e8e8e8] dark:border-[#242937] bg-white dark:bg-[#1e2330] text-base leading-6 text-[#1a222b] dark:text-[#f8fafc] outline-none transition-colors placeholder:text-[#6b7280] dark:placeholder:text-[#94a3b8] focus-visible:border-gray-400 dark:focus-visible:border-gray-600 focus-visible:ring-1 focus-visible:ring-gray-400/20 disabled:cursor-not-allowed disabled:bg-[#f7f8f7] dark:disabled:bg-[#151821] disabled:text-[#6b7280] dark:disabled:text-[#64748b] aria-invalid:border-accent aria-invalid:ring-2 aria-invalid:ring-accent/15";
