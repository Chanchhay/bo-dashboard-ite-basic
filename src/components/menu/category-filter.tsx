    ...
    <div className="w-full text-gray-900 dark:text-gray-100 font-sans space-y-5">
      ...
      <div className="flex items-center justify-between">
        <button
          ...
          className="size-11 rounded-full border border-gray-200 dark:border-gray-800 bg-white dark:bg-[#1a1e29] shadow-2xs hover:border-primary hover:bg-gray-50 dark:hover:bg-gray-800/80 flex items-center justify-center transition-all cursor-pointer group"
          aria-label="Search items"
        >
          <SearchIcon className="size-5 text-gray-700 dark:text-gray-200 group-hover:text-primary transition-colors" />
        </button>
        ...
        {isFiltered && (
          <button
            ...
            className="text-xs font-bold text-primary hover:underline cursor-pointer md:hidden"
          >
            Clear all
          </button>
        )}
      ...
      <div className="flex items-baseline justify-between border-b border-gray-200 dark:border-gray-800/80 pb-3">
        ...
        {isFiltered && (
          <button
            type="button"
            onClick={onResetFilters}
            className="hidden md:inline-block text-xs font-semibold text-primary hover:underline cursor-pointer"
          >
            Clear all
          </button>
        )}
                ...
                <div
                  className={cn(
                    ...
                    isChecked
                      ...
                      : "border-gray-300 dark:border-gray-700 bg-white dark:bg-[#1a1e29] group-hover:border-primary"
                  )}
                >
                  {isChecked && <Check className="size-3 stroke-[3]" />}
                </div>
                <span className={cn("truncate", isChecked && "font-bold text-primary dark:text-primary")}>
                  {cat}
                </span>
              </label>
            );
          ...
          <div className="w-full max-w-3xl rounded-2xl sm:rounded-[32px] bg-white dark:bg-[#151923] p-4 sm:p-7 shadow-2xl border border-gray-200/80 dark:border-gray-800 space-y-4 sm:space-y-5 my-auto animate-in zoom-in-95 duration-200">
            ...
            <div className="flex items-center gap-2.5 sm:gap-4">
              ...
              <button
                ...
                className="text-sm sm:text-base font-bold text-primary hover:text-primary/80 px-1 sm:px-2 py-1 transition-colors cursor-pointer shrink-0"
              >
                Cancel
              </button>
            </div>
