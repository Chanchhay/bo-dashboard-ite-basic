...
//   const [renameOrder, { isLoading: isRenaming }] = useRenameOrderMutation();
//   const [clearOrder] = useClearOrderMutation();
//   const [pay, { isLoading: isPaying }] = usePayMutation();
...
//       await renameOrder({ name: data.name, comment: data.comment }).unwrap();
...
//               <th className="px-4 py-3 text-center font-semibold text-gray-700">Product</th>
