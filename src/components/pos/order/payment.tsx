...
export function Payment({
  ...
  return (
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="w-full p-4 sm:max-w-xl sm:p-6">
          <DialogHeader className="flex-row items-center gap-2 space-y-0">
            <CreditCard className="h-5 w-5 text-primary" />
            <h2 className="text-lg font-bold">Payment</h2>
          </DialogHeader>

          <div className="grid grid-cols-1 gap-6 pt-2 sm:grid-cols-2 sm:gap-10">
            {/* Left: order summary */}
            <div className="flex flex-col gap-4">
              <h3 className="text-xs font-bold tracking-wide text-gray-500">
                ORDER SUMMARY
              ...
              <div className="flex w-full flex-col gap-2">
                ...
                <div className="flex gap-2 sm:gap-3">
                  <button
                    type="button"
                    onClick={() => setMethod("CASH")}
                    className={`flex flex-1 flex-col items-center justify-center gap-1 rounded-xl border px-2 py-3 text-xs font-semibold transition-colors sm:flex-row sm:gap-2 sm:py-2.5 sm:text-sm ${
                      method === "CASH"
                        ? "border-secondary bg-amber-50 text-accent"
                        : "border-gray-200 text-gray-500 hover:bg-gray-50"
                    }`}
                  >
                    <Banknote className="h-5 w-5 shrink-0 sm:h-4 sm:w-4" />
                    Cash
                  </button>
                  <button
                    type="button"
                  ...
                  >
                    <CreditCard className="h-5 w-5 shrink-0 sm:h-4 sm:w-4" />
                    Card
                  </button>
                </div>
              </div>
