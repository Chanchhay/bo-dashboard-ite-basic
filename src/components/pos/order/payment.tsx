...
export interface PaymentProps {
  ...
  /**
   * No connection, so cash is the only thing this till can settle.
   *
   * A KHQR code is not a payment on its own: it has to be generated by the
   * bank and then confirmed by it, and neither can happen with the server out
   * of reach. Offering it would put a code on screen that can never be
   * settled, and the customer would have paid into nothing.
   */
  offline?: boolean;
}
