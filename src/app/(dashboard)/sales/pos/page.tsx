...
export default function PosScreen() {
  ...
  const currentOrder: Order = { items: [], id: "1", created_at: "", status: "OPEN" as any, subtotal: "0", discount_amount: "0", total: "0" } as any;
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden bg-background min-[1025px]:flex-row">
      {/* Left: switches based on active tab */}
      <div className="flex flex-1 flex-col overflow-hidden">
        <div className="scrollbar-none flex-1 overflow-y-auto pb-20 [-ms-overflow-style:none] min-[1025px]:pb-0 [&::-webkit-scrollbar]:hidden">
            ...
            (paidReceipt ? (
              ...
              <div className="px-3 pt-4 sm:px-6 sm:pt-6">
                {isLoading ? (
                  ...
                  // 2 columns everywhere up to 1024px, desktop ladder from 1025px
                   <div className="grid grid-cols-2 gap-3 place-items-center sm:grid-cols-3 sm:gap-4 md:grid-cols-4 min-[900px]:grid-cols-5 min-[1025px]:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
          ...
          {/* Discount / Modify tabs — not built yet */}
        </div>
      ...
      {/* Right: cart panel — fixed sidebar from 1025px up, kept at w-150 */}
      {showCart && (
      ...
      {/* 0–1024px: floating "view cart" bar, only when there's something to show */}
      ...
      {/* 0–1024px: full-screen cart drawer */}
