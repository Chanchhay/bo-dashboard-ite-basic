...
function BusinessHeader({ managerName }: { managerName: string }) {
    return (
        ...
        <aside className="border-r border-[#e5e7eb] bg-white lg:min-h-[calc(100vh-93px)]">
            ...
            >
                ...
                <Link
                    ...
                    className="flex min-w-40 items-center gap-3 rounded-lg px-3 py-0.5 text-base leading-[35px] tracking-[0.96px] text-[#020409] opacity-70 lg:w-full"
                >
                    <Image
...
export default async function BusinessProfilePage() {
    ...
    return (
        <div className="min-h-screen bg-white text-[#161d16]">
            <BusinessHeader managerName={managerName} />
